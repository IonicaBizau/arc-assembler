...
when = {
  ...
  allowOverwrite: function allowOverwrite(questions) {
    return questions.overwrite === undefined || questions.overwrite == 'yes';
  },
  notAuto: function notAuto(questions) {
  ...
  express: function express(questions) {
    return questions.install === 'express' && (questions.overwrite === undefined || questions.overwrite == 'yes');
  },

  // customize
  customize: function customize(questions) {
    return questions.customize === true;
  },
  primaryColor: function primaryColor(questions) {
    return questions.primaryColor;
  },
  secondaryColor: function secondaryColor(questions) {
