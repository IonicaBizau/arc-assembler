      ...
      module = {
        ...
        get: {
          text: function text(templateText) {
            ...
            templateText = templateText.replace('{value}', value).replace('{total}', total).replace('{percent}', percent);
        ...
        set: {
          ...
          percent: function percent(_percent) {
            ...
            if (module.total) {
              module.value = Math.round(_percent / 100 * module.total);
            }
            ...
            $.proxy(settings.onChange, element)(_percent, module.value, module.total);
          },
