        ...
        g = [].slice.call(arguments, 1);return a.each(function () {
      {
        var a,
          ...
          a.storage.remove(d.key);
            ...
            var i;return "localstorage" == d.storageMethod && o.localStorage !== t ? i = o.localStorage.getItem(n) : e.cookie !== t ? i = e.cookie(n) : a.error(f.noCookieStorage), ("undefined" == i || "null" == i || i === t || null === i) && (i = t), i;
