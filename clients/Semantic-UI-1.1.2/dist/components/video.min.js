  ...
  e.fn.video = function (t) {
    {
      ...
      var d,
          ...
          T = F.find(f.embed),
          z = this,
          A = F.data(x);d = { initialize: function initialize() {
          ...
          d.debug("Playing video");var e = F.data(b.source) || !1,
              o = F.data(b.url) || !1,
              t = F.data(b.id) || !1;T.html(d.generate.html(e, t, o)), F.addClass(g.active), p.onPlay();
          ...
          d.error = Function.prototype.bind.call(console.error, console, p.name + ":"), d.error.apply(console, arguments);
            ...
            var o, t, n;p.performance && (o = new Date().getTime(), n = l || o, t = o - n, l = o, c.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: z, "Execution Time": t })), clearTimeout(d.performance.timer), d.performance.timer = setTimeout(d.performance.display, 100);
          ...
          var r,
              l,
              c,
              u = A;return t = t || m, i = z || i, "string" == typeof o && u !== n && (o = o.split(/[\. ]/), r = o.length - 1, e.each(o, function (t, a) {
            var i = t != r ? a + o[t + 1].charAt(0).toUpperCase() + o[t + 1].slice(1) : o;if (e.isPlainObject(u[i]) && t != r) u = u[i];else {
              if (u[i] !== n) return l = u[i], !1;if (!e.isPlainObject(u[a]) || t == r) return u[a] !== n ? (l = u[a], !1) : !1;u = u[a];
            }
