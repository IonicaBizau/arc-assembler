  ...
  e.fn.shape = function (a) {
    var o,
      ...
      var t,
          ...
          m,
          p = r.selector || "",
          v = e.extend(!0, {}, e.fn.shape.settings, a),
          h = v.namespace,
          b = v.selector,
          x = v.error,
          y = v.className,
          ...
          k = !1,
          T = this,
          A = w.data(z);m = { initialize: function initialize() {
          ...
          m.verbose("Forcing repaint event");{
            var e = C.get(0) || i.createElement("div");e.offsetWidth;
          }
        }, animate: function animate(i, a) {
          ...
          m.verbose("Animating states reset"), w.removeClass(y.animating).attr("style", "").removeAttr("style"), C.attr("style", "").removeAttr("style"), W.attr("style", "").removeAttr("style").removeClass(y.hidden), f.removeClass(y.animating).attr("style", "").removeAttr("style");
            ...
            e = e || v.duration, e = "number" == typeof e ? e + "ms" : e, m.verbose("Setting animation duration", e), C.add(W).css({ "-webkit-transition-duration": e, "-moz-transition-duration": e, "-ms-transition-duration": e, "-o-transition-duration": e, "transition-duration": e });
          }, stageSize: function stageSize() {
            var e = w.clone().addClass(y.loading),
                t = e.find("." + v.className.active),
                i = k ? e.find(b.side).eq(k) : t.next(b.side).size() > 0 ? t.next(b.side) : e.find(b.side).first(),
                n = {};t.removeClass(y.active), i.addClass(y.active), e.insertAfter(w), n = { width: i.outerWidth(), height: i.outerHeight() }, e.remove(), w.css(n), m.verbose("Resizing stage to fit new content", n);
            ...
            var e,
                ...
                a = { transition: "transitionend", OTransition: "oTransitionEnd", MozTransition: "transitionend", WebkitTransition: "webkitTransitionEnd" };for (e in a) {
              if (t.style[e] !== n) return a[e];
            }
          ...
          m.error = Function.prototype.bind.call(console.error, console, v.name + ":"), m.error.apply(console, arguments);
            ...
            var t, i, n;v.performance && (t = new Date().getTime(), n = s || t, i = t - n, s = t, d.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: T, "Execution Time": i })), clearTimeout(m.performance.timer), m.performance.timer = setTimeout(m.performance.display, 100);
          ...
          var r,
              s,
              d,
              u = A;return i = i || c, a = T || a, "string" == typeof t && u !== n && (t = t.split(/[\. ]/), r = t.length - 1, e.each(t, function (i, a) {
            var o = i != r ? a + t[i + 1].charAt(0).toUpperCase() + t[i + 1].slice(1) : t;if (e.isPlainObject(u[o]) && i != r) u = u[o];else {
              if (u[o] !== n) return s = u[o], !1;if (!e.isPlainObject(u[a]) || i == r) return u[a] !== n ? (s = u[a], !1) : !1;u = u[a];
            }
