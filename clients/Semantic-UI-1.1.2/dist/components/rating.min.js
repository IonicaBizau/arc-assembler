      ...
      var g,
          ...
          x = C.find(p.icon);
            ...
            var n = e(this),
                t = g.getRating(),
                i = x.index(n) + 1,
                a = "auto" == d.clearable ? 1 === x.size() : d.clearable;a && t == i ? g.clearRating() : g.setRating(i);
          } }, clearRating: function clearRating() {
          g.debug("Clearing current rating"), g.setRating(0);
        }, getRating: function getRating() {
          var e = x.filter("." + f.active).size();return g.verbose("Current rating retrieved", e), e;
        ...
        }, setRating: function setRating(n) {
          var t = n - 1 >= 0 ? n - 1 : 0,
              i = x.eq(t);C.removeClass(f.selected), x.removeClass(f.selected).removeClass(f.active), n > 0 && (g.verbose("Setting current rating to", n), i.prevAll().andSelf().addClass(f.active)), e.proxy(d.onRate, y)(n);
          ...
          g.error = Function.prototype.bind.call(console.error, console, d.name + ":"), g.error.apply(console, arguments);
            ...
            var n, t, i;d.performance && (n = new Date().getTime(), i = r || n, t = n - i, r = n, s.push({ Name: e[0], Arguments: [].slice.call(e, 1) || "", Element: y, "Execution Time": t })), clearTimeout(g.performance.timer), g.performance.timer = setTimeout(g.performance.display, 100);
          ...
          var r,
              s,
              l,
              c = R;return a = a || u, o = y || o, "string" == typeof n && c !== i && (n = n.split(/[\. ]/), r = n.length - 1, e.each(n, function (t, a) {
