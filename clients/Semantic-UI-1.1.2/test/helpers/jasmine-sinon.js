...
(function (jasmine, beforeEach) {
  ...
  var sinon = typeof require === 'function' && (typeof module === 'undefined' ? 'undefined' : _typeof(module)) === 'object' ? require('sinon') : window.sinon,
    ...
    "alwaysThrew": "toHaveAlwaysThrown"
      ...
      createCustomMatcher = function createCustomMatcher(arg) {
    return sinon.match(function (val) {
      return jasmine.getEnv().equals_(val, arg);
    });
  },
      getMatcherFunction = function getMatcherFunction(sinonName, matcherName) {
