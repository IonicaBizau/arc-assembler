...
;(function ($, window, document, undefined) {
  ...
  $.fn.sticky = function (parameters) {
    ...
    $allModules.each(function () {
      var settings = $.extend(true, {}, $.fn.sticky.settings, parameters),
      ...
      module = {
        ...
        set: {
          ...
          scroll: function scroll(_scroll2) {
            module.debug('Setting scroll on element', _scroll2);
            if (module.is.top()) {
              $module.css('bottom', '').css('top', -_scroll2);
            }
            if (module.is.bottom()) {
              $module.css('top', '').css('bottom', _scroll2);
            }
          },
          size: function size() {
        ...
        bindTop: function bindTop() {
          ...
          $module.css('left', '').css('top', '').css('bottom', '').removeClass(className.fixed).removeClass(className.bottom).addClass(className.bound).addClass(className.top);
        ...
        bindBottom: function bindBottom() {
          ...
          module.remove.offset();
          $module.css('left', '').css('top', '').css('bottom', '').removeClass(className.fixed).removeClass(className.top).addClass(className.bound).addClass(className.bottom);
        ...
        fixTop: function fixTop() {
          ...
          module.set.offset();
          $module.css('left', module.cache.element.left).removeClass(className.bound).removeClass(className.bottom).addClass(className.fixed).addClass(className.top);
        ...
        fixBottom: function fixBottom() {
          ...
          module.set.offset();
          $module.css('left', module.cache.element.left).removeClass(className.bound).removeClass(className.top).addClass(className.fixed).addClass(className.bottom);
          $.proxy(settings.onStick, element)();
        },
