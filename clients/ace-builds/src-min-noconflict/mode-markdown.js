...
ace.define("ace/mode/doc_comment_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  function c(e, t) {
    ...
    return "(?:[^" + i.escapeRegExp(e) + "\\\\]|\\\\.)*";
      ...
      h = function h() {
    a.call(this), this.$rules.start.unshift({ token: "empty_line", regex: "^$", next: "allowBlock" }, { token: "markup.heading.1", regex: "^=+(?=\\s*$)" }, { token: "markup.heading.2", regex: "^\\-+(?=\\s*$)" }, { token: function token(e) {
  ...
  var r = e("../../lib/oop"),
    ...
    this.foldingStartMarker = /^(?:[=-]+\s*$|#{1,6} |`{3})/, this.getFoldWidget = function (e, t, n) {
      var r = e.getLine(n);return this.foldingStartMarker.test(r) ? r[0] == "`" ? e.bgTokenizer.getState(n) == "start" ? "end" : "start" : "start" : "";
    }, this.getFoldWidgetRange = function (e, t, n) {
      function l(t) {
        return f = e.getTokens(t)[0], f && f.type.lastIndexOf(c, 0) === 0;
      }function h() {
        var e = f.value[0];return e == "=" ? 6 : e == "-" ? 5 : 7 - f.value.search(/[^#]/);
      }var r = e.getLine(n),
          i = r.length,
          o = e.getLength(),
          u = n,
          a = n;if (!r.match(this.foldingStartMarker)) return;if (r[0] == "`") {
        if (e.bgTokenizer.getState(n) !== "start") {
          while (++n < o) {
            r = e.getLine(n);if (r[0] == "`" & r.substring(0, 3) == "```") break;
          }return new s(u, i, n, 0);
        }while (n-- > 0) {
          r = e.getLine(n);if (r[0] == "`" & r.substring(0, 3) == "```") break;
        }return new s(n, r.length, u, 0);
      }var f,
          c = "markup.heading";if (l(n)) {
        var p = h();while (++n < o) {
          if (!l(n)) continue;var d = h();if (d >= p) break;
        }a = n - (!f || ["=", "-"].indexOf(f.value[0]) == -1 ? 1 : 2);if (a > u) while (a > u && /^\s*$/.test(e.getLine(a))) {
          a--;
        }if (a > u) {
          var v = e.getLine(a).length;return new s(u, i, a, v);
        }
      }
    };
  }.call(o.prototype);
  ...
  var r = e("../lib/oop"),
    ...
    this.type = "text", this.blockComment = { start: "<!--", end: "-->" }, this.getNextLineIndent = function (e, t, n) {
      if (e == "listblock") {
        var r = /^(\s*)(?:([-+*])|(\d+)\.)(\s+)/.exec(t);if (!r) return "";var i = r[2];return i || (i = parseInt(r[3], 10) + 1 + "."), r[1] + i + r[4];
      }return this.$getIndent(t);
