...
define("ace/mode/c9search_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  function o(e, t) {
    try {
      ...
      u = function u() {
    this.$rules = { start: [{ tokenNames: ["c9searchresults.constant.numeric", "c9searchresults.text", "c9searchresults.text", "c9searchresults.keyword"], regex: "(^\\s+[0-9]+)(:\\s)(.+)", onMatch: function onMatch(e, t, n) {
          var r = this.splitRegex.exec(e),
              ...
              a,
              f = 0;if (o && o.exec) {
            o.lastIndex = 0;while (a = o.exec(u)) {
              var l = u.substring(f, a.index);f = o.lastIndex, l && s.push({ type: i[2], value: l });if (a[0]) s.push({ type: i[3], value: a[0] });else if (!l) break;
            }
          }return f < u.length && s.push({ type: i[2], value: u.substr(f) }), s;
        } }, { token: ["string", "text"], regex: "(\\S.*)(:$)" }, { regex: "Searching for .*$", onMatch: function onMatch(e, t, n) {
          var r = e.split("");if (r.length < 3) return "text";var s,
              u,
              a,
              f = 0,
              l = [{ value: r[f++] + "'", type: "text" }, { value: u = r[f++], type: "text" }, { value: "'" + r[f++], type: "text" }];r[2] !== " in" && (a = r[f], l.push({ value: "'" + r[f++] + "'", type: "text" }, { value: r[f++], type: "text" })), l.push({ value: " " + r[f++] + " ", type: "text" }), r[f + 1] ? (s = r[f + 1], l.push({ value: "(" + r[f + 1] + ")", type: "text" }), f += 1) : f -= 1;while (f++ < r.length) {
            r[f] && l.push({ value: r[f], type: "text" });
          }a && (u = a, s = ""), u && (/regex/.test(s) || (u = i.escapeRegExp(u)), /whole/.test(s) && (u = "\\b" + u + "\\b"));var c = u && o("(" + u + ")", / sensitive/.test(s) ? "g" : "ig");return c && (n[0] = t, n[1] = c), l;
  ...
  var r = e("../../lib/oop"),
      ...
      o = t.FoldMode = function () {};r.inherits(o, s), function () {
    this.foldingStartMarker = /^(\S.*\:|Searching for.*)$/, this.foldingStopMarker = /^(\s+|Found.*)$/, this.getFoldWidgetRange = function (e, t, n) {
      var r = e.doc.getAllLines(n),
          ...
          a = o.test(s) ? o : u,
          f = n,
          l = n;if (this.foldingStartMarker.test(s)) {
        for (var c = n + 1, h = e.getLength(); c < h; c++) {
          if (a.test(r[c])) break;
        }l = c;
      } else if (this.foldingStopMarker.test(s)) {
        for (var c = n - 1; c >= 0; c--) {
          s = r[c];if (a.test(s)) break;
        }f = c;
      }if (f != l) {
        var p = s.length;return a === o && (p = s.search(/\(Found[^)]+\)$|$/)), new i(f, p, l, 0);
      }
    };
  }.call(o.prototype);
  ...
  var r = e("../lib/oop"),
    ...
    this.getNextLineIndent = function (e, t, n) {
      var r = this.$getIndent(t);return r;
