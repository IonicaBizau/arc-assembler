...
define("ace/mode/abap_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  function a() {
    this.HighlightRules = r, this.foldingRules = new i();
      ...
      s = e("../range").Range,
      o = e("./text").Mode,
      u = e("../lib/oop");u.inherits(a, o), function () {
    this.getNextLineIndent = function (e, t, n) {
      var r = this.$getIndent(t);return r;
    }, this.toggleCommentLines = function (e, t, n, r) {
      var i = new s(0, 0, 0, 0);for (var o = n; o <= r; ++o) {
        var u = t.getLine(o);if (hereComment.test(u)) continue;commentLine.test(u) ? u = u.replace(commentLine, "$1") : u = u.replace(indentation, "$&#"), i.end.row = i.start.row = o, i.end.column = u.length + 1, t.replace(i, u);
      }
