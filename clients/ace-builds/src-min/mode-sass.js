...
define("ace/mode/scss_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  var r = e("../lib/oop"),
      ...
      o = function o() {
    s.call(this);var e = this.$rules.start;e[1].token == "comment" && (e.splice(1, 1, { onMatch: function onMatch(e, t, n) {
        return n.unshift(this.next, -1, e.length - 2, t), "comment";
      }, regex: /^\s*\/\*/, next: "comment" }, { token: "error.invalid", regex: "/\\*|[{;}]" }, { token: "support.type", regex: /^\s*:[\w\-]+\s/ }), this.$rules.comment = [{ regex: /^\s*/, onMatch: function onMatch(e, t, n) {
