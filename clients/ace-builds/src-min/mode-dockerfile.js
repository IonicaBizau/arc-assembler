...
define("ace/mode/sh_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function (e, t, n) {
  ...
  var r = e("../lib/oop"),
    ...
    this.lineCommentStart = "#", this.getNextLineIndent = function (e, t, n) {
      ...
      n += 1;var r = this.$getIndent(t.getLine(n)),
          i = t.getTabString();r.slice(-i.length) == i && t.remove(new o(n, r.length - i.length, n, r.length));
    }, this.$id = "ace/mode/sh";
  ...
  var r = e("../lib/oop"),
      ...
      s = function s() {
    i.call(this);var e = this.$rules.start;for (var t = 0; t < e.length; t++) {
      if (e[t].token == "variable.language") {
        e.splice(t, 0, { token: "constant.language", regex: "(?:^(?:FROM|MAINTAINER|RUN|CMD|EXPOSE|ENV|ADD|ENTRYPOINT|VOLUME|USER|WORKDIR|ONBUILD|COPY)\\b)", caseInsensitive: !0 });break;
      }
    }
