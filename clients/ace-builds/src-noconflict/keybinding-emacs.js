...
ace.define("ace/keyboard/emacs", ["require", "exports", "module", "ace/lib/dom", "ace/incremental_search", "ace/commands/incremental_search_commands", "ace/keyboard/hash_handler", "ace/lib/keys"], function (require, exports, module) {
    ...
    exports.handler.bindKey = function (key, command) {
        if ((typeof key === "undefined" ? "undefined" : _typeof(key)) == "object") key = key[this.platform];
        if (!key) return;
        ...
        setMark: {
            exec: function exec(editor, args) {
                ...
                if (transientMarkModeActive && (mark || !hasNoSelection)) {
                    if (editor.inMultiSelectMode) editor.forEachSelection({ exec: editor.clearSelection.bind(editor) });else editor.clearSelection();
        ...
        killRingSave: {
            exec: function exec(editor) {
                ...
                setTimeout(function () {
                    ...
                    editor.$handlesEmacsOnCopy = false;
                    if (editor.inMultiSelectMode) editor.forEachSelection({ exec: deselect });else deselect();
